...
public class PetCoPage extends WrapperClass {
	...
	public void fishAndFood() throws InterruptedException {
		...
		Thread.sleep(2000);
		action.moveToElement(driver.findElement(By.linkText("Fish"))).build().perform();
		Thread.sleep(1000);
		action.moveToElement(driver.findElement(By.linkText("Frozen Food"))).click().build().perform();
	}
